...
comment on table advertiser is 'This table stores Advertiser details as is pushed from SalesForce';
comment on column advertiser.advertiser_id is 'Auto-generated ID for advertisers';
comment on column advertiser.account_id is 'SF sourced account ID';
comment on column advertiser.account_name is 'SF sourced name of the account';
comment on column advertiser.account_mail_id is 'SF sourced mail ID for the account';
comment on column advertiser.roo is 'ROO for this advertiser';
comment on column advertiser.sub_roo is 'Sub ROO for this advertiser';
comment on column advertiser.pod is 'Pod for this advertiser';
comment on column advertiser.sub_pod is 'Sub pod for this advertiser';
comment on column advertiser.created_at is 'Timestamp when this entry was created';
comment on column advertiser.modified_at is 'Timestamp when this entry was modified';
comment on column advertiser.modified_by is 'ID of the user who modified this entry';


create table io_details(
    io_details_id serial primary key,
    advertiser_id integer references advertiser(advertiser_id),
    parent_io_id integer,
    io_number integer,
    total_budget float,
...
comment on column io_details.io_number is 'IO Number as sourced from SalesForce';
...
comment on column io_details.created_at is 'Timestamp when this entry was created';
comment on column io_details.modified_at is 'Timestamp when this entry was modified';
...
create table rate_card(
    ...
    advertiser_id integer references advertiser(advertiser_id),
    name varchar(255),
    created_by varchar(255) DEFAULT now(),
    created_at timestamp without time zone not null default now()
);
...
comment on column rate_card.advertiser_id is 'Advertiser ID which references advertiser table';
...
comment on column rate_card.created_at is 'Timestamp when this entry was created';
...
comment on column channel_io_rule.created_at is 'Timestamp when this entry was created';
comment on column channel_io_rule.modified_at is 'Timestamp when this entry was modified';
...
comment on column campaign_details.created_at is 'Timestamp when this entry was created';
comment on column campaign_details.modified_at is 'Timestamp when this entry was modified';
